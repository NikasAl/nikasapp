...
public class SiteAppsController {
    ...
    enum AppNames {
        mahjong, spacetank3D, faceball3D, xmastree, follow3D, growingcherry, arimaa3D, numbers2048, starfinder;
    }
    ...
    @RequestMapping("/follow3D")
    public String follow3D(Map<String, Object> map) {
        ResourceBundle mRB = brs().get(AppNames.follow3D.name());
        fillMapWithResources(map, mRB);
        return "app";
    }

    @RequestMapping("/growingcherry")
    public String growingcherry(Map<String, Object> map) {
        ResourceBundle mRB = brs().get(AppNames.growingcherry.name());
        fillMapWithResources(map, mRB);
        return "app";
    }

    @RequestMapping("/arimaa3D")
    public String arimaa3D(Map<String, Object> map) {
        ResourceBundle mRB = brs().get(AppNames.arimaa3D.name());
        fillMapWithResources(map, mRB);
        return "app";
    }

    @RequestMapping("/numbers2048")
    public String numbers2048(Map<String, Object> map) {
        ResourceBundle mRB = brs().get(AppNames.numbers2048.name());
        fillMapWithResources(map, mRB);
        return "app";
    }

    @RequestMapping("/starfinder")
    public String starfinder(Map<String, Object> map) {
        ResourceBundle mRB = brs().get(AppNames.starfinder.name());
        fillMapWithResources(map, mRB);
        return "app";
    }
